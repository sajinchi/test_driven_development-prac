...
import { ProductUpdateService } from "@/src/services/product/productUpdate.service";

const Update = (props:{data:IProduct}) => {
    const {
      register,
      handleSubmit,
      formState: { errors },
    ...
    const onSubmit = async (data: IProductCreateData) => {
      ...
      if (imageUpload.status == 200) {
        ...
        const response = await ProductUpdateService(
          data.name,
          data.amount,
                            ...
                            <div className="flex flex-row space-x-6">
                              ...
                              <div className="flex-grow flex-col">
                                ...
                                <input
                                  ...
                                  defaultValue={props.data.inventory}
                                  className={`pl-3 w-full h-10 rounded-lg border outline-none ${
                                    errors.inventory &&
                                    "focus:border-red-500 focus:ring-red-500 border-red-500"
                                  }`}
